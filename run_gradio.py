...
models = {
    ...
    "base2 • Cmaj/Amin":    load_model("base2",  "CA",    DEVICE, tokenizer),
    "random • Cmaj/Amin":   load_model("random", "CA",    DEVICE, tokenizer),
}
print("✅ Models ready")
...
with gr.Blocks(css=css) as demo:
    ...
    with gr.Row():
        ...
        with gr.Column():
            ...
            clear_btn.click(
                ...
                inputs=None, 
                outputs=[file_in, orig_viewer, clear_btn]
            )            

            file_in.change(render_original,   inputs=file_in, outputs=orig_viewer)
    ...
    run_btn.click(
        fn=harmonise,
        inputs=[file_in, variant, constraints],
