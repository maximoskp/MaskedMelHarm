...
def main():
    ...
    os.makedirs('results/bar/' + subfolder + '/', exist_ok=True)
    if curriculum_type == 'random':
        results_path = 'results/bar/' + subfolder + '/' + curriculum_type + str(total_stages) + '.csv'
    else:
        results_path = 'results/bar/' + subfolder + '/' + curriculum_type + '.csv'

    os.makedirs('saved_models/bar/', exist_ok=True)
    os.makedirs('saved_models/bar/' + subfolder + '/', exist_ok=True)
    save_dir = 'saved_models/bar/' + subfolder + '/'
    if curriculum_type == 'random':
