...
from models import GridMLMMelHarmNoStage
import torch
...
def main():
    ...
    # save results
    os.makedirs('results/no_stage/', exist_ok=True)
    results_path = 'results/no_stage/' + curriculum_type + '.csv'
    
    save_dir = 'saved_models/no_stage/'
